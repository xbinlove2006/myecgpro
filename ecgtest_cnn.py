...
divided_sigs=divided_sigs.permute(0,2,1) #[489,1,6000]
num=torch.Tensor(num)
x_train=divided_sigs[50:]
y_target=num[50:]
x_train=x_train.type(torch.FloatTensor)
y_target=y_target.type(torch.LongTensor)
x,y=Variable(x_train),Variable(y_target)
